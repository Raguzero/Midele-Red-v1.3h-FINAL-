...
; if it's a stone evolution entry
	...
	jr nz, .checkEvolutionsLoop
; if it does match
; NUEVO CORREGIR EL ABLE/NO ABLE EN USO DE PIEDRA AL NV30
	dec hl
    dec hl
    ld b, [hl]
    inc hl
    ...
    cp b ; ¿tiene un nivel al menos igual al necesario?
    jr c, .checkEvolutionsLoop ; si no, pues a comprobar otra
; NUEVO CORREGIR EL ABLE/NO ABLE EN USO DE PIEDRA AL NV30
