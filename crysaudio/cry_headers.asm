...
PolitoedCryHeader: ; 0xf2c8b   ;168  sneasel modificado
	dw $38  ; cry id
	db $43  ; pitch
	db $00  ; echo
	dw $0af ; length

SmeargleCryHeader: ; 0xf2d03   ;169
	dw $40  ; cry id
	db $e6  ; pitch
	db $fd  ; echo
	dw $1f0 ; length
...
TyranitarCryHeader: ; 0xf2d51   ;176
	dw $2a  ; cry id
	db $00  ; pitch
	db $ff  ; echo
	dw $180 ; length

SteelixCryHeader: ; 0xf2c61  ;177
	dw $3a  ; cry id
	db $ef  ; pitch
	db $00  ; echo
	dw $0f7 ; length
...
HeracrossCryHeader: ; 0xf2c85   ;186  
	dw $3e  ; cry id
	db $35  ; pitch
	db $00  ; echo
	dw $0e0 ; length

HoundourCryHeader: ; 0xf2cd9  ;187
	dw $30  ; cry id
	db $39  ; pitch
	db $00  ; echo
	dw $140 ; length

HoundoomCryHeader: ; 0xf2cdf  ;188
	dw $32  ; cry id
	db $f6  ; pitch
	db $fe  ; echo
	dw $100 ; length

ChinchouCryHeader: ; 0xf2b7d  ;189
	dw $30  ; cry id
	db $c9  ; pitch
	db $03  ; echo
	dw $140 ; length

LanturnCryHeader: ; 0xf2b83  ;190
	dw $30  ; cry id
	db $d0  ; pitch
	db $02  ; echo
	dw $110 ; length	

MurkrowCryHeader: ; 0xf2c25  ;191
	dw $26  ; cry id
	db $e1  ; pitch
	db $ff  ; echo
	dw $180 ; length
...
SunfloraCryHeader: ; 0xf2c25  ;192 MISMO GRITO QUE MURKROW
	dw $26  ; cry id
	db $e1  ; pitch
	db $ff  ; echo
	dw $180 ; length
...
SkarmoryCryHeader: ; 0xf2cd3    ; 198
	dw $3e  ; cry id
	db $a9  ; pitch
	db $08  ; echo
	dw $180 ; length

MiltankCryHeader: ; 0xf2d27  ; 199
	dw $33  ; cry id
	db $33  ; pitch
	db $fe  ; echo
	dw $1a0 ; length
...
TogepiCryHeader: ; 0xf2b9b   ;215
	dw $28  ; cry id
	db $10  ; pitch
	db $00  ; echo
	dw $100 ; length

TogeticCryHeader: ; 0xf2ba1  ;216
	dw $2c  ; cry id
	db $3b  ; pitch
	db $00  ; echo
	dw $038 ; length
...
SlugmaCryHeader: ; 0xf2ba1  ;217  MISMO GRITO QUE TOGETIC
	dw $2c  ; cry id
	db $3b  ; pitch
	db $00  ; echo
	dw $038 ; length
	
EspeonCryHeader: ; 0xf2c19   ;218
	dw $41  ; cry id
	db $a2  ; pitch
	db $00  ; echo
	dw $140 ; length

UmbreonCryHeader: ; 0xf2c1f  ;219
	dw $1a  ; cry id
	db $17  ; pitch
	db $ff  ; echo
	dw $0f0 ; length
...
PiloswineCryHeader:   ; 220 LEAFEON
	dw $1a  ; cry id
	db $88  ; pitch
	db $00  ; echo
	dw $0e0 ; length
...
CrobatCryHeader: ; 0xf2b77  ;224
	dw $1d  ; cry id
	db $f0  ; pitch
	db $ff  ; echo
	dw $140 ; length

ScizorCryHeader: ; 0xf2c79 ;225
	dw $3e  ; cry id
	db $00  ; pitch
	db $00  ; echo
	dw $160 ; length
...
DelibirdCryHeader: ; 0xf2a21   226 MISMO GRITO QUE RHYDON
	dw $11  ; cry id
	db $00  ; pitch
	db $00  ; echo
	dw $100 ; length

KingdraCryHeader: ; 0xf2ce5  ;227
	dw $35  ; cry id
	db $fb  ; pitch
	db $02  ; echo
	dw $100 ; length
...
SmoochumCryHeader: ; 0xf296d  228 MISMO GRITO QUE MAGNETON
	dw $1c  ; cry id
	db $20  ; pitch
	db $00  ; echo
	dw $140 ; length
...
ElekidCryHeader: ; 0xf2a2d  229 MISMO GRITO QUE TANGELA
	dw $12  ; cry id
	db $00  ; pitch
	db $00  ; echo
	dw $100 ; length
...
MantineCryHeader: ; 0xf2a6f  230 MISMO GRITO QUE ELECTABUZZ
	dw $06  ; cry id
	db $8f  ; pitch
	db $00  ; echo
	dw $17f ; length
...
PhanpyCryHeader: ; 0xf2a75  231 MISMO GRITO QUE MAGMAR
	dw $04  ; cry id
	db $ff  ; pitch
	db $00  ; echo
	dw $0b0 ; length
...
DonphanCryHeader: ; 0xf2a09  ; 232  Cry de Lickitung modificado
	dw $0c  ; cry id
	db $00  ; pitch
	db $fd  ; echo
	dw $100 ; length

Porygon2CryHeader: ; 0xf2cf7   ;233
	dw $29  ; cry id
	db $73  ; pitch
	db $00  ; echo
	dw $240 ; length
...
StantlerCryHeader: ; 0xf2cf7   ;234  MISMO GRITO QUE PORYGON2
	dw $29  ; cry id
	db $73  ; pitch
	db $00  ; echo
	dw $240 ; length
...
LugiaCryHeader: ; 0xf27bd 235 EL MISMO GRITO QUE CATERPIE
	dw $16  ; cry id
	db $80  ; pitch
	db $00  ; echo
	dw $0a0 ; length
...
TyrogueCryHeader: ; 0xf2817 236 EL MISMO GRITO QUE PIKACHU
	dw $0f  ; cry id
	db $ee  ; pitch
	db $00  ; echo
	dw $081 ; length
...
HoppipCryHeader: ; 0xf2be3   238
	dw $34  ; cry id
	db $3b  ; pitch
	db $00  ; echo
	dw $0c8 ; length

SkiploomCryHeader: ; 0xf2be9   239
	dw $34  ; cry id
	db $27  ; pitch
	db $00  ; echo
	dw $138 ; length

JumpluffCryHeader: ; 0xf2bef ;240
	dw $34  ; cry id
	db $00  ; pitch
	db $00  ; echo
	dw $180 ; length
...
PupitarCryHeader: ; 0xf2c5b  ;247 MISMO GRITO QUE GLIGAR
	dw $33  ; cry id
	db $fe  ; pitch
	db $fe  ; echo
	dw $100 ; length
...
HoOhCryHeader: ; 0xf2d63  250 MISMO GRITO QUE CELEBI
	dw $37  ; cry id
	db $4a  ; pitch
	db $01  ; echo
	dw $111 ; length

CelebiCryHeader: ; 0xf2d63  251
	dw $37  ; cry id
	db $4a  ; pitch
	db $01  ; echo
	dw $111 ; length

CryHeader252: ; 0xf2d69  252
	dw 0    ; cry id
	db 0    ; pitch
	db 0    ; echo
	dw 0    ; length
