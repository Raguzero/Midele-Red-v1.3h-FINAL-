...
_TrainerNameText::
; BORRADO PARA CONSEGUIR ESPACIO  Remove pointless routine and its redundant name table
	;TX_RAM wcd6d
	TX_RAM wTrainerName  ; NUEVO
	; BORRADO PARA CONSEGUIR ESPACIO  Remove pointless routine and its redundant name table
	text ": @@"
...
; NUEVO PARA PREGUNTAS BLAINE CON MAS OPCIONES
	;text "CATERPIE evolves"
	;line "into BUTTERFREE?"
	text "Quien gano el"
	line "primer Nacional"
	cont "de Pokespain?"
	done
...
_CinnabarQuizQuestionsText3::
	text "Quien es el"
	line "creador de la"
	cont "Guarderia Midele?"
	done

_CinnabarQuizQuestionsText4::
	text "Quien derribo una"
	line "papelera con una"
	cont "Patada Salto?"
	done
...
_CinnabarQuizQuestionsText6::
	text "Segun la leyenda"
	line "de que tipo es"
	cont "ENTEI?"
	; NUEVO PARA PREGUNTAS BLAINE CON MAS OPCIONES BORRADO LO ANTERIOR
	done
...
_Sony1WinText::
	; NUEVO PARA MENSAJE VICTORIA DE ENTRENADOR RIVAL
	;text "<RIVAL>: Yeah! Am"
	text "Yeah! Am"
	; NUEVO PARA MENSAJE VICTORIA DE ENTRENADOR RIVAL
...
INCLUDE "text/maps/underground_we.asm" ; NUEVO MAPA UNDERGROUND WE
...
INCLUDE "text/item_descriptions.asm" ; NUEVO MENU OBJETOS

SECTION "Text 14", ROMX, BANK[TEXT_14]
INCLUDE "text/maps/diglettscave.asm" ; NUEVO ENTRENADORES CUEVA DIGGLET
INCLUDE "text/maps/cerulean_police.asm" ; NUEVO MAPA POLICIA
INCLUDE "text/maps/unknown_dungeon1.asm"  ; NUEVO
INCLUDE "text/maps/unknown_dungeon2.asm"  ; NUEVO
INCLUDE "text/maps/underground_ns.asm" ; NUEVO PARA UNDERGROUND NS

SECTION "Text 15", ROMX, BANK[TEXT_15]
INCLUDE "text/maps/micolomap3.asm"; NUEVO MAPA LAB MICOLO
INCLUDE "text/maps/micolomap2.asm"; NUEVO MAPA LAB MICOLO
INCLUDE "text/maps/silvercave1.asm"; NUEVO PARA ENTRENADORES SILVER CAVE
