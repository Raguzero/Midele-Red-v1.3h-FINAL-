...
; NUEVO BORRADO PARA HACER ESPACIO EN HOME
;OverwritewMoves::
...
LoadMonFrontSprite::
	...
	ld hl, wMonHSpriteDim
	ld a, [hli]
LoadUncompressedBackSprite: ; NUEVO PARA SPRITEBACK DE GSC USABLE
	ld c, a
	pop de
	; fall through
...
ReadTrainerHeaderInfo::
	...
	add hl, de
	pop af
	pop de ; NUEVO ARREGLAR BUG DE MENSAJE DERROTA
	and a
	jr nz, .nonZeroOffset
	ld a, [hl]
...
InitBattleEnemyParameters::
	...
	;jr c, .noTrainer ; NUEVO PARA ENTRENADORES NO SON POKEMON
	ld [wTrainerNo], a
	ret
.noTrainer
    ld a, [wEngagedTrainerSet] ; NUEVO PARA ENTRENADORES NO SON POKEMON
	ld [wCurEnemyLVL], a
	ret
...
PrintEndBattleText::
	...
	ld [MBC1RomBank], a
	push hl
	;callba SaveTrainerName ; BORRADO PARA CONSEGUIR ESPACIO  Remove pointless routine and its redundant name table 
...
PlayTrainerMusic::
	...
	cp OPP_SONY3
	ret z
	; NUEVO PARA MUSICA DE ENFRENTAMIENTO
	cp OPP_DISCAL
    ret z
	cp OPP_MANEC
    jr nz, .noManec
...
.noManec
	; NUEVO PARA MUSICA DE ENFRENTAMIENTO
	; NUEVO PARA ARREGLAR FALLO DE POKES ESTATUA
	cp VOLTORB
	ret z
	cp ELECTRODE
	ret z
