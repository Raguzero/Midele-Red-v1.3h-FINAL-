...
wTempDVs:: ; NUEVO PARA DVS PERSONALIZADOS EN ENTRENADORES
wTempPic::
wOverworldMap:: ; c6e8
	ds 1300
...
wTrainerPicBank:: ; d032  	; NUEVO PARA SPRITES ENTRENADORES EN CUALQUIER BANK
	ds 1
...
wPokedexOwnedEnd::
	...
	;QUITADO PORQUE DABA BUG AL GUARDAR Y ENCENDER EN ESCALERA/PUERTA
...
; NUEVO REMATCH LIDERES
wGymLeaderRematch:: ; d5a3
;wUnusedD5A3:: ; d5a3
; NUEVO REMATCH LIDERES	
	ds 1
...
wUnknownDungeon1CurScript:: ; 
	ds 1
wUnknownDungeon2CurScript:: ; 
	ds 1
; NUEVO
; NUEVO PARA MAPA UNDERGROUND WE
wUndergroundweCurScript:: 
    ds 1 
; NUEVO PARA MAPA UNDERGROUND WE
wRoute18GateCurScript:: ; d669
	ds 1
; NUEVO PARA MEW
wVermilionDockCurScript:: 
    ds 1
; NUEVO PARA MEW
; NUEVO PARA RANDOM TRAINER
wIndigoPlateauLobbyCurScript:: 
    ds 1
; NUEVO PARA RANDOM TRAINER
;NUEVO PARA MAPA SILVER CAVE
wRoute28CurScript::
    ds 1
;NUEVO PARA MAPA SILVER CAVE
; NUEVO SILVER CAVE BATALLA ESPECIAL
wSilverCave3CurScript:: ;
	ds 1
; NUEVO SILVER CAVE BATALLA ESPECIAL
; NUEVO ENTRENADORES CUEVA DIGGLET
wDiglettsCaveCurScript::
	ds 1
; NUEVO ENTRENADORES CUEVA DIGGLET
; NUEVO MAPA POLICIA
wCeruleanPoliceCurScript::
	ds 1
; NUEVO MAPA POLICIA
; NUEVO PARA MICOLO MAPA LAB
wMicoloMap1CurScript::
	ds 1
wMicoloMap2CurScript::
	ds 1
wMicoloMap3CurScript::
	ds 1
; NUEVO PARA MICOLO MAPA LAB
;NUEVO PARA MAPA SILVER CAVE
wSilverCaveOutsideCurScript:: ;
    ds 1
;NUEVO PARA MAPA SILVER CAVE
;NUEVO PARA MAPA UNDERGROUND NS
wUndergroundNSCurScript:: 
    ds 1
;NUEVO PARA MAPA UNDERGROUND NS
; NUEVO PARA ENTRENADORES SILVER CAVE
wSilverCave1CurScript:: ;
    ds 1
; NUEVO PARA ENTRENADORES SILVER CAVE
	ds 67
