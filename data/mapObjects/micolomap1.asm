MicoloMap1Object:
	...
	object SPRITE_BLACK_HAIR_BOY_1, 34, 10, STAY, UP, 9 ; person
	object SPRITE_OAK_AIDE, 23, 4, STAY, RIGHT, 10 ; person
	object SPRITE_GAMBLER, 28, 2, STAY, DOWN, 11 ; person
	object SPRITE_OAK_AIDE, 36, 4, STAY, LEFT, 12 ; person
	object SPRITE_FISHER2, 29, 7, STAY, UP, 13	; person
	object SPRITE_BALL, 24, 32, STAY, NONE, 14 ; person
	object SPRITE_BOULDER,  1,  5, STAY, BOULDER_MOVEMENT_BYTE_2, 15
	...
	warp_to  4,  5, MICOLOMAP1_WIDTH ; MICOLO MAP1 ;NUEVO MAPA MICOLO LAB
