AttackAnimationPointers:
	...
	dw WingAttackAnim ; BUGAZO
	dw SlashAnim ; METAL_CLAW
	dw AuroraBeamAnim ; ICY_WIND
	dw DoubleEdgeAnim ; BRAVE BIRD
	dw HolareinaAnim ; HOLA REINA N.N
	dw StruggleAnim
	dw ShowPicAnim
	dw EnemyFlashAnim
	dw PlayerFlashAnim
