...
MapHSPointers:
	...
	dw MapHSXX
	dw MapHSXX
	dw MapHS52; NUEVO PARA ROCK TUNNEL dw MapHSXX
	dw MapHS53
	dw MapHSXX
	dw MapHSXX
	dw MapHSXX
	...
	dw MapHSXX
	dw MapHSXX
	dw MapHS5E ;dw MapHSXX  NUEVO PARA MEW
	dw MapHSXX
	dw MapHS60
	dw MapHSXX
	dw MapHSXX
	...
	dw MapHSXX
	dw MapHSXX
	dw MapHS73 ; NUEVO MICOLOMAP1 	dw MapHSXX
	dw MapHS74 ; NUEVO MICOLOMAP2 	dw MapHSXX
	dw MapHS75 ; NUEVO MICOLOMAP3	;dw MapHSXX
	dw MapHSXX
	dw MapHSXX
	dw MapHS78
	dw MapHS79	;NUEVO UNDERGROUND WE dw MapHSXX
	dw MapHSXX
	dw MapHSXX
	dw MapHSXX
	dw MapHSXX
...
MapHS0D:
	;db ROUTE_2,$01,Show ; NUEVO BORRADO PARA ENTRENADOR NUEVO, AÑADIDO PARA QUE HAYA 3 OBJECTS FUNCIONANDO EN ROUTE 2
	db ROUTE_2,$02,Show  ; MICOLO
	db ROUTE_2,$03,Show  ; MOON STONE
	db ROUTE_2,$04,Show ; PP_UP ; NUEVO PARA ENTRENADOR NUEVO, AÑADIDO PARA QUE HAYA 3 OBJECTS FUNCIONANDO EN ROUTE 2
MapHS0F:
    db ROUTE_4,$03,Show ; NUEVO POLICIA RUTA 4
	db ROUTE_4,$04,Show ; NUEVO antes 3
MapHS14:
	db ROUTE_9,$0A,Show
MapHS17:
	db ROUTE_12,$01,Show
...
MapHSE4:
	db UNKNOWN_DUNGEON_1,$08,Show ; NUEVO SUBIDO PARA ENTRENADOR NUEVO
	db UNKNOWN_DUNGEON_1,$09,Show ; NUEVO SUBIDO PARA ENTRENADOR NUEVO
	db UNKNOWN_DUNGEON_1,$0A,Show ; NUEVO SUBIDO PARA ENTRENADOR NUEVO
MapHS8F:
...
MapHS33:
; NUEVO MODIFICADO PARA AÑADIR 2 ENTRENADORES DE POKEMON YELLOW BOSQUE VERDE
	db VIRIDIAN_FOREST,$08,Show ; antes 05
	db VIRIDIAN_FOREST,$09,Show ; antes 06
	db VIRIDIAN_FOREST,$0A,Show ; antes 07
; NUEVO MODIFICADO PARA AÑADIR 2 ENTRENADORES DE POKEMON YELLOW BOSQUE VERDE
MapHS3B:
...
MapHSE2:
	db UNKNOWN_DUNGEON_2,$07,Show ; NUEVO SUBIDO A 2
	db UNKNOWN_DUNGEON_2,$08,Show ; NUEVO SUBIDO A 3
	db UNKNOWN_DUNGEON_2,$09,Show ; NUEVO SUBIDO A 4
MapHSE3:
...
; NUEVO MAPAS
MapHS6D:
	db SILVER_CAVE_ROOM_1,$06,Show
	db SILVER_CAVE_ROOM_1,$07,Show
MapHS6E:
...
MapHSC1:
	db ROUTE_22_GATE,$02,Show
	db ROUTE_22_GATE,$03,Show
; NUEVO MAPAS
; NUEVO PARA ROCK TUNNEL
MapHS52:
	db ROCK_TUNNEL_1,$08,Show
; NUEVO PARA ROCK TUNNEL
	; NUEVO UNDERGROUND WE
MapHS79:
	db UNDERGROUND_PATH_WE,$01,Show
	db UNDERGROUND_PATH_WE,$02,Show
	db UNDERGROUND_PATH_WE,$03,Show
	db UNDERGROUND_PATH_WE,$04,Show
	db UNDERGROUND_PATH_WE,$05,Show
	db UNDERGROUND_PATH_WE,$06,Show
	; NUEVO UNDERGROUND WE
; NUEVO MICOLOMAP
MapHS73:
	db MICOLOMAP1,8,Show
	db MICOLOMAP1,14,Show
	db MICOLOMAP1,15,Show ; NUEVO (BLOQUEO DE ROCA)
MapHS74:
	db MICOLOMAP2,$06,Show
	db MICOLOMAP2,$07,Show
MapHS75:
	db MICOLOMAP3,$06,Show
	db MICOLOMAP3,$07,Show
	db MICOLOMAP3,$08,Show
; NUEVO MICOLOMAP
	db $FF,$01,Show
