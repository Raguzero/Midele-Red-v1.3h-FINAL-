...
MoveEnd:
	...
	move IRON_HEAD,   FLINCH_SIDE_EFFECT2,        80, STEEL,      100, 20
	move STEEL_WING,    DEFENSE_UP1_SIDE_EFFECT,        70, STEEL,      90, 25
	move OUTRAGE,       THRASH_PETAL_DANCE_EFFECT,   120, DRAGON,   100, 10
	move ENERGY_BALL,   SPECIAL_DOWN_SIDE_EFFECT,             90, GRASS,    100, 10
	move MIDELE_POWER, TRAPPING_EFFECT,				     100, UNKNOWN,  100,   5
	move DARK_THUNDER, TWO_TO_FIVE_ATTACKS_EFFECT,  60, UNKNOWN,  100,   10
    ...
    move BUGAZO,   EXPLODE_EFFECT,        255, UNKNOWN,      100, 15
	...
	move HOLA_REINA, NO_ADDITIONAL_EFFECT,        1, UNKNOWN, 100, 10
	move STRUGGLE,     RECOIL_EFFECT,               50, UNK,   100, 10
