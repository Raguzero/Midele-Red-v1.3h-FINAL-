ExternalMapEntries:
	...
	EMAP $0,$7,Route28Name 	; NUEVO MAPAS DE SILVER CAVE
	EMAP $2,$A,Route1Name
	EMAP $2,$6,Route2Name
	EMAP $4,$3,Route3Name
	EMAP $8,$2,Route4Name
	...
	EMAP $0,$7,SilverCaveName 	; NUEVO MAPAS DE SILVER CAVE
...
InternalMapEntries:
	...
	; NUEVO MAPAS DE SILVER CAVE
	IMAP SILVER_CAVE_POKECENTER,    $0,$7,SilverCaveName
	IMAP ROUTE_28_HOUSE,            $0,$7,Route28Name
	; NUEVO MAPAS DE SILVER CAVE
	IMAP VICTORY_ROAD_1,            $0,$4,VictoryRoadName
	IMAP SILVER_CAVE_ITEM_ROOMS,     $0,$7,SilverCaveName 	; NUEVO MAPAS DE SILVER CAVE
