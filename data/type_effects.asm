...
;     00 is ×0
	...
	db ICE,GROUND,20
	db ICE,FLYING,20
	db ICE,FIRE,05  ; actualizado a gen 7
	...
	db POISON,POISON,05
	db POISON,GROUND,05
;db POISON,BUG,20 ; actualizado a gen 7, es neutro, por tanto no se menciona
	db POISON,ROCK,05
	db POISON,GHOST,05
	db GROUND,FIRE,20
	...
	db BUG,PSYCHIC,20
	db BUG,GHOST,05
	db BUG,POISON,05 ;db BUG,POISON,20 ; actualizado a gen 7
	db ROCK,FIRE,20
	db ROCK,FIGHTING,05
	db ROCK,GROUND,05
	db ROCK,FLYING,20
	...
	db ROCK,ICE,20
	db GHOST,NORMAL,00
	db GHOST,PSYCHIC,20 ; actualizado a como estaba intencionado
	db FIRE,DRAGON,05
	db WATER,DRAGON,05
