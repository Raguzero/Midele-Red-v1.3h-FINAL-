...
const_value = 0
	...
	const HS_ROUTE_2_MICOLO         ; 19 X   ; NUEVO MAPA ROUTE 2 MICOLO
	const HS_ROUTE_2_ITEM_1               ; 19 X
	const HS_ROUTE_2_ITEM_2               ; 1A X
	const HS_POLIRUTA4 ; NUEVO POLICIA RUTA 4, ESPERO NO DE BUG POR PONERSE AQUI
	...
	; NUEVO MAPAS
	const HS_MEW ; NUEVO PARA MEW
	const HS_SILVERCAVE1_ITEM1            ; E4
	const HS_SILVERCAVE1_ITEM2            ; E5
	const HS_SILVERCAVE2_ITEM1            ; E8
	const HS_SILVERCAVE2_ITEM2            ; E9
	const HS_SILVERCAVE2_ITEM3            ; EA
	const HS_SILVERCAVEITEMS_ITEM1        ; EB
	const HS_SILVERCAVEITEMS_ITEM2        ; EC
	const HS_ROUTE22GATE_NEWGUARD1        ; ED
	const HS_ROUTE22GATE_NEWGUARD2        ; EE
; NUEVO MAPAS
	; NUEVO ROCK TUNNEL
	const HS_MANEC ; EF
	; NUEVO ROCK TUNNEL
	; NUEVO UNDERGROUND WE
	const HS_PACOCHEF1 ; F0
	const HS_LAVENDER1 ; F1
	const HS_DOBLEC ; F2
	const HS_KADERETE1 ; F3
	const HS_KRUB1 ; F4
	const HS_GOLEM ; F5
	; NUEVO UNDERGROUND WE
	; NUEVO MICOLOMAP1
	const HS_GMASTER ; F6
	const HS_DARKPIKA ; F7
	const HS_ROCK_BLOCK  ; F8
	; NUEVO MICOLOMAP1
	; NUEVO MICOLOMAP2
	const HS_CATERMANOBALL ; F9
	const HS_MICOLOMAP2ITEM1 ; FA
	; NUEVO MICOLOMAP2
	; NUEVO MICOLOMAP3
	const HS_MICOLOMAP3ITEM1 ; FB
	const HS_MICOLOMAP3ITEM2 ; FC
	const HS_MICOMON ; FD
	; NUEVO MICOLOMAP3
