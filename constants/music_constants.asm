...
; NUEVAS MUSICAS
    const MUSIC_CITIES1_SLOW
	const MUSIC_MEET_RIVAL_ALT_START
	const MUSIC_MEET_RIVAL_ALT_TEMPO
	const MUSIC_MEET_RIVAL_ALT_START_AND_TEMPO
	const MUSIC_MOTHER_BEAST
	const MUSIC_HeartMulholland
	const MUSIC_FrontierBrain
	const MUSIC_RocketBattle
	const MUSIC_SuicuneBattle
	const MUSIC_Pinballgengarstage_gastly
	const MUSIC_HoennWild
	const MUSIC_JohtoWildBattle
	const MUSIC_SinnohWildBattle
	const MUSIC_WildBattleSM
	const MUSIC_BWWild
	const MUSIC_CCCP
	const MUSIC_20thCenturyFox_flauta
	const MUSIC_MadWorld
	const MUSIC_AlolaEliteFourBattle
	const MUSIC_ChampionBattle_B2W2
	const MUSIC_ZinniaBattle
	const MUSIC_UnovaEliteFourBattle
	const MUSIC_SinnohGameCorner
	const MUSIC_TCGImakuni
	const MUSIC_RivalBattle_XY
	const MUSIC_FiestaPagana
	const MUSIC_LookGladion
	const MUSIC_EyesOfFlame
	const MUSIC_SplatoonTheme
	const MUSIC_MirorB
	const MUSIC_SteelSamurai
	const MUSIC_MAGruntBattle
	const MUSIC_Guile
	const MUSIC_OurHouse
	const MUSIC_Cornered
	const MUSIC_NGE
	const MUSIC_NGE_Intro
	const MUSIC_LaSantaEspina
	const MUSIC_Contra
	const MUSIC_LacunosaTown
	const MUSIC_PetalburgCity
; NUEVAS MUSICAS
