...
RockTunnel1TrainerHeader7:
	dbEventFlagBit EVENT_460, 1
	db ($4 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_460, 1
	...
	dw RockTunnel1WinBattleText8 ; TextEndBattle
; NUEVO
	db $ff
...
RockTunnel1WinBattleText8:
	TX_FAR _RockTunnel1WinBattleText8
	db "@"
; NUEVO
