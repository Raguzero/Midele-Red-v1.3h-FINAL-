Route23Script:
	...
	ld hl, Route23TrainerHeader0
    ld de, Route23ScriptPointers
...
Route23TextPointers:
	...
	dw Route23Text6
	dw Route23Text7
	dw Route23Text ; NUEVO
	dw Route23Text8

; NUEVO

Route23TrainerHeader0:
	dbEventFlagBit EVENT_KAISSER, 1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_KAISSER, 1  
	dw Route23BattleText2 ; TextBeforeBattle
	dw Route23AfterBattleText2 ; TextAfterBattle
	dw Route23EndBattleText2 ; TextEndBattle
	dw Route23WinBattleText2 ; TextEndBattle
...
Route23BattleText2:
	TX_FAR _Route23BattleText2
	db "@"

Route23EndBattleText2:
	TX_FAR _Route23EndBattleText2
	db "@"

Route23AfterBattleText2:
	TX_FAR _Route23AfterBattleText2
	db "@"

Route23WinBattleText2:
	TX_FAR _Route23WinBattleText2
	db "@"
; NUEVO	
