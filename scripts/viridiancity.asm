...
ViridianCityScript0:
    callab ShowHideGymLeaderGiovanni ; NUEVO REMATCH LIDERES
...
.asm_1901e
	...
	cp $20
	ret nz
	; CARTEL MOVE DELETER RELEARNER, LO DE ABAJO ES EL CARTEL INVISIBLE DE PUERTA GYM
	;ld a, $e
	ld a, $f
...
ViridianCityScript2:
	...
	xor a
	ld [wJoyIgnore], a
	; CARTEL MOVE DELETER RELEARNER, LO DE ABAJO ES EL VIDEO QUE ENSEÑA A CAPTURAR DEL TEXTO DESPUES DE ATRAPAR POKEMON
	;ld a, $f
	ld a, $10
	; CARTEL MOVE DELETER RELEARNER
	ld [hSpriteIndexOrTextID], a
...
ViridianCityTextPointers:
	...
	dw ViridianCityText16 ; CARTEL MOVE DELETER RELEARNER
